                ...
                <table class="table">
                    ...
                    @foreach($users as $user)
                        <tr role="row" class="">
                            ...
                            : "<span class='text-success'>تأیید نشده</span>" !!}</td>
                            <td>
                                <a href=""
                                ...
                                <a href="{{ route('users.edit', $user->id) }}" class="item-edit mlg-15"
                                   title="ویرایش"></a>
                                <a href=""
                                   onclick="updateConfirmationStatus(event, '{{ route('users.manualVerify', $user->id)}}', 'آیا از تأیید این آیتم اطمینان دارید؟'                                     , 'تأیید شده');"
