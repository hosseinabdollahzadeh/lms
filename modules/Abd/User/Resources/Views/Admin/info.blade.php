        ...
        <div class="col-12">
            ...
            <div class="w-100 padding-20 border-radius-3 bg-white margin-left-10 margin-bottom-10">
                <ul>
                    ...
                    <li>بایو: <strong>{{$user->bio}}</strong></li>
                    <li>موجودی حساب: <strong>{{number_format($user->balance)}}</strong></li>
                    <li>تاریخ تأیید ایمیل:
                        <strong>{{$user->email_verified_at ? \Morilog\Jalali\Jalalian::fromCarbon($user->email_verified_at) : "تأیید نشده"}}</strong>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <table class="table">
                    ...
                    @foreach($user->courses as $course)
                        <tr role="row" class="">
                            ...
                            <td>{{number_format($course->amount)}}</td>
